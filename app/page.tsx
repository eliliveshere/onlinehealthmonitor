            ...
            {formStatus === 'idle' ? (
              <>
                <div className="flex items-start justify-between gap-4 mb-5">
                  ...
                  <div className="hidden rounded-lg border border-zinc-100 bg-zinc-50 px-2 py-1.5 text-[10px] font-bold uppercase tracking-wide text-zinc-500 md:block">
                ...
                <form onSubmit={handleAuditSubmit} className="grid gap-4 relative z-10">
                  <div>
                    ...
                    <input
                      required
                      type="text"
                      className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-zinc-900 focus:bg-white transition-all placeholder-zinc-400"
                  ...
                  <button
                    type="submit"
                    className="mt-1 inline-flex w-full items-center justify-center rounded-xl bg-zinc-900 px-5 py-3 font-bold text-white hover:bg-zinc-800 transition-all shadow-lg shadow-zinc-900/10 active:scale-[0.98]"
                  >
                    Send my free audit
                  </button>
